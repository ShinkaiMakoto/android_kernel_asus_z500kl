...
#define IC_RESET			8
#define WORK_FUNC		9
#define ESD_ENABLE		10
#define TP_ID_PIN		11
#define READ_TP_ID		12
#define WR_NODE 		13
#define CLEAN_CFG		14
#define GESTURE_FUNC	15
#define READ_DISPLAY_ID	16
#define GET_RAW_DATA	17
...
DEVICE_ATTR(touch_status, (S_IWUSR | S_IRUGO), gt6108_status, NULL);
...
static ssize_t gt6108_get_file_fw_version(struct device *dev, struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "6108_%04x-%d\n", tp_file_vid, tp_file_config);
}
static DEVICE_ATTR(file_fw_version, (S_IWUSR | S_IRUGO), gt6108_get_file_fw_version, NULL);

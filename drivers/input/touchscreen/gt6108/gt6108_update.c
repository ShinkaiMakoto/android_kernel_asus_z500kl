...
extern int GT6108_ATDFWUpdate;

extern u8 tp_file_config;
extern u16 tp_file_vid;
...
static s8 gup_update_config(struct i2c_client *client)
{
    ...
    tp_file_config =  (file_config + 2)[0];
    i = 0;
...
#if defined(TOUCH_ENG_BUILD)
if(GT6108_ATDFWUpdate==0){
    GTP_INFO("alp.D : eng build bypass search files");
    searching_file = 1;
    got_file_flag = 0x00;
    return;
}

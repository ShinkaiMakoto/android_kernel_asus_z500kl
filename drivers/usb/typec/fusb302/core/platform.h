...
typedef enum {
	EXTEVT_BATT_CAPACITY_CHANGE = 0, /* battery capacity change */
	EXTEVT_INVALID,
} external_event;
...
struct connecting_state_descriptor
{
	ConnectionState conn_state;
	FSC_BOOL cc1;		/* CC1 orientation */
	FSC_BOOL cc2;		/* CC2 orientation */
	CCTermType termination_type;
};

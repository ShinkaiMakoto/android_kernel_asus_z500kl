...
/*
 * Call this function every 1000us for the core's timers.
 */
void core_tick(void)
{
    TypeCTick();
...
ConnectionState core_get_connecting_state(struct connecting_state_descriptor *desc)
{
	return StateMachineGetConnectingState(desc);
}

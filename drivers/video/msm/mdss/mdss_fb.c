...
#if defined(TARGET_PROJECT_ZT500KL_DISPLAY)||defined(TARGET_PROJECT_Z500KL_DISPLAY)
	if(entry_mode == 4 && mfd->index == 0) {
		pr_warn("entry_mode = %d, mfd->index = %d, fb_release and set bl 0\n", entry_mode, mfd->index);
		mdss_fb_set_backlight(mfd, 0);
		lp8557e01_set_brightness(0);
		lp8557e01_suspend();
	}
#endif

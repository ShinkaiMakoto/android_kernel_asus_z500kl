...
#elif defined(TARGET_PROJECT_Z581KL_DISPLAY)
extern void iris2_io_resume(void);
extern void iris2_io_suspend(void);
#elif defined(TARGET_PROJECT_ZT582KL_DISPLAY)
extern void iris2_io_resume(void);
extern void iris2_io_suspend(void);
#elif defined(TARGET_PROJECT_ZT500KL_DISPLAY)
extern void iris2_io_resume(void);
extern void iris2_io_suspend(void);
extern void lp8557e01_suspend(void);
extern void lp8557e01_resume(void);
extern void lp8557e01_set_brightness(int level);
							...
							u32 bl_level)
{
	...
	case BL_PWM:
		...
		break;
	case BL_DCS_CMD_IRIS:
#if defined(TARGET_PROJECT_ZT500KL_DISPLAY)||defined(TARGET_PROJECT_Z500KL_DISPLAY)
		//auo_panel_bl_write(ctrl_pdata, bl_level);
		lp8557e01_set_brightness(bl_level);
...
static int mdss_dsi_panel_on(struct mdss_panel_data *pdata)
{
...
#if defined(CONFIG_IRIS2_FULL_SUPPORT) || defined(CONFIG_IRIS2_LIGHTUP_ONLY) || defined(CONFIG_IRIS2P_FULL_SUPPORT) || defined(CONFIG_IRIS2P_LIGHTUP_ONLY)
	...
	// Iris2 chip.
	iris2_init(ctrl);
	iris2_panel_cmds(ctrl, PANEL_ON_CMDS);
	iris2_lightup(ctrl);
#elif (defined(CONFIG_IRIS2P_FULL_SUPPORT) || defined(CONFIG_IRIS2P_LIGHTUP_ONLY)) && !defined(WITHOUT_IRIS)
#if defined(CONFIG_IRIS2P_FULL_SUPPORT)
	if (iris2_get_chip_version() < IRIS2P_50) {
		// Iris2 chip.
		iris2_init(ctrl);
...
#endif // CONFIG_IRIS2_FULL_SUPPORT, CONFIG_IRIS2P_FULL_SUPPORT
...
static int mdss_dsi_panel_off(struct mdss_panel_data *pdata)
{
	...
	iris2_lightoff(ctrl);
	iris2_panel_cmds(ctrl, PANEL_OFF_CMDS);
	iris2_lightoff_finish(ctrl);
	...
	if (data) {
		if (!strcmp(data, "bl_ctrl_wled")) {
			...
			pr_debug("%s: Configured DCS_CMD bklt ctrl\n",
								__func__);
		} else if (!strcmp(data, "bl_ctrl_dcs_iris")) {
			ctrl_pdata->bklt_ctrl = BL_DCS_CMD_IRIS;
			pr_debug("%s: Configured DCS_CMD_IRIS bklt ctrl\n",
								__func__);
		}
	}
	return 0;

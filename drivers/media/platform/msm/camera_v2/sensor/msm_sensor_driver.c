...
//ASUS_BSP+++ for ATD status
	if(strcmp("t4k35",slave_info->sensor_name) == 0) {
		ATD_camera_status = 1;
	...
	} else if (strcmp("t4k35_4lane",slave_info->sensor_name) == 0) {
                ATD_camera_status = 1;
                ATD_camera_id = 35;//camera_info->sensor_id;
                msm_sensor_driver_dbgfs_init(0);
        } else if (strcmp("ov5670",slave_info->sensor_name) == 0) {
                ATD_vga_status = 1;
                ATD_vga_id = 5670;//camera_info->sensor_id;
                msm_sensor_driver_dbgfs_init(1);
        } else if (strcmp("ov5670_polaris",slave_info->sensor_name) == 0) {
                ATD_vga_status = 1;
                ATD_vga_id = 5670;//camera_info->sensor_id;
                msm_sensor_driver_dbgfs_init(1);
		...
		ATD_camera_status = 1;
                ...
                msm_sensor_driver_dbgfs_init(0);
	} else if (strcmp("ov13850",slave_info->sensor_name) == 0) {
		ATD_camera_status = 1;
		ATD_camera_id = 13850;//camera_info->sensor_id;
		msm_sensor_driver_dbgfs_init(0);
	}
//ASUS_BSP--- for ATD status

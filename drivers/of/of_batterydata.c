		...
		const char *psy_name,  const char  *batt_type)
{
	...
	char *batt_name = "2342476_asus_zt500kl_7800mah_averaged_masterslave_apr11th2016";
	...
	for_each_child_of_node(batterydata_container_node, node) {
		/*Add for battery data*/
        of_property_read_string(node, "qcom,battery-type", &battery_type);

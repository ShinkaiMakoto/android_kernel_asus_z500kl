...
enum {
	...
	POWER_SUPPLY_STATUS_QC_V1_CHARGING = 8,
	POWER_SUPPLY_STATUS_QC_V2_CHARGING,
	POWER_SUPPLY_STATUS_NOT_QC_CHARGING,
};
...
enum {
	...
	POWER_SUPPLY_SCOPE_SOURCE,
	POWER_SUPPLY_SCOPE_SINK,
};

enum {
	POWER_SUPPLY_TYPEC_MODE_UNKNOWN = 0,
	POWER_SUPPLY_TYPEC_MODE_SOURCE,
	POWER_SUPPLY_TYPEC_MODE_SINK,
	POWER_SUPPLY_TYPEC_MODE_DFP,
	POWER_SUPPLY_TYPEC_MODE_UFP,
};
